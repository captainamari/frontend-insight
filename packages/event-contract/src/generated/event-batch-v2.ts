/* AUTO-GENERATED from schema/event-batch-v2.schema.json. Do not edit directly. */
...
/**
 * Browser-to-ingestion transport contract with anonymous operation lifecycle correlation.
 */
export interface FrontendInsightEventBatchV2 {
  schemaVersion: 2;
  projectKey: string;
  sentAt: string;
  sdk: Sdk;
