...
const reasonLabels: Record<string, string> = {
  ...
  HISTORICAL_VERSION_NOT_RECALCULATED: "该区段属于历史版本，未使用当前定义重算",
  ALERT_FACT_STORE_UNAVAILABLE: "告警事实存储读取失败，无法评估",
  ALERT_INSUFFICIENT_SAMPLE: "已有性能样本不足20条，固定规则无法评估",
  METRIC_GRANULARITY_UNSUPPORTED: "此定义不支持当前趋势粒度",
  NO_EVENTS_IN_BUCKET: "本桶没有可查询事件",
  NO_QUERYABLE_ATOMIC_FACT: "没有可查询的对应原子事实",
  METRIC_MINIMUM_SAMPLE_NOT_MET: "指标样本不足",
